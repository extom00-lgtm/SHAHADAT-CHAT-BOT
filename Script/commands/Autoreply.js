...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু আয়ান বস বেশি করে 😏💖",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ AYAN AHMED ☜\nFacebook: https://www.facebook.com/profile.php?id=100086576874686\nWhatsApp: +60176912863",
    "admin": "He is AYAN AHMED তাকে সবাই Admin AYAN হিসেবে চিনে😘☺️",
    ...
    "ki koros": "বস আয়ান এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সব কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    "valo aso": "হ্যাঁ রে প্রিও, বস আয়ান এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… আয়ান বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস আয়ান এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি আয়ান বস কে বল জানু 😻🔥"
  };
